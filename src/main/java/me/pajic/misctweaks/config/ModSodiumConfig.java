		...
		builder.registerOwnModOptions()
				...
				.addPage(builder.createOptionPage()
						...
						.addOption(builder.createIntegerOption(Identifier.parse("misctweaks:current_dimension_brightness"))
								...
								.setEnabledProvider(_ -> ModClientUtil.getCurrentBrightness() != -2, ConfigState.UPDATE_ON_REBUILD)
						...
						.addOption(builder.createIntegerOption(Identifier.parse("misctweaks:raise_hotbar"))
								...
								.setTooltip(_ -> MiscTweaksClient.RAISED_LOADED ?
								...
								.setEnabledProvider(_ -> !MiscTweaksClient.RAISED_LOADED)
