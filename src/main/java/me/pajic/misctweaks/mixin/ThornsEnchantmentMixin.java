...
public class ThornsEnchantmentMixin {
    ...
    private boolean preventEquipmentDamage(ItemStack instance, int i, LivingEntity livingEntity, Consumer<LivingEntity>consumer) {
        return !ModServerConfig.thornsNoDamage;
    }
}
