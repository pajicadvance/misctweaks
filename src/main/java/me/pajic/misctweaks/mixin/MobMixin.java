...
public class MobMixin {
    ...
    private boolean animalPickupFood(Mob instance, /*? if >= 1.21.11 {*/ServerLevel level,/*?}*/ ItemEntity itemEntity) {
    ...
    private boolean preventBadCheck(ItemStack candidate, ItemStack existing, /*? if >= 1.21.11 {*/EquipmentSlot slot,/*?}*/ Operation<Boolean> original) {
        ...
        return original.call(candidate, existing/*? if >= 1.21.11 {*/, slot/*?}*/);
    }
}
